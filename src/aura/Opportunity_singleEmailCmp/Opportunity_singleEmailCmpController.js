({
	doinit : function(component, event, helper) {
	  ...
	  var actionAcc = component.get("c.get_currentOpp");
        actionAcc.setParams({
          ...
          //  
            if(emailType =='Personal Email' ){
                ...
                if( selAcc.Work_Email__c ==undefined || selAcc.Work_Email__c==''){
           			          ...
           			          inputCmp.set("v.errors", [{message:"Work Email Not exist for this Account"}]);
