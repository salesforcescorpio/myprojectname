          ...
          //  
            if(emailType =='Personal Email' ){
                if( selAcc.Email ==undefined || selAcc.Email==''){
                     ...
                     inputCmp.set("v.errors", [{message:"Personal Email Not exist for this Lead"}]);
                }else{
                    component.set("v.isDisabled","false");
                    inputCmp.set("v.errors", null);
					 component.set("v.EmailIs",selAcc.Email);
                }
            }
                ...
                if( selAcc.Official_Email__c ==undefined || selAcc.Official_Email__c==''){
           			          ...
           			          inputCmp.set("v.errors", [{message:"Official Email Not exist for this Lead"}]);
                    
                    component.set("v.isDisabled","true");
                    component.set("v.EmailIs",""); 
                }else{
                    component.set("v.EmailIs",selAcc.Official_Email__c);
                    component.set("v.isDisabled","false");
                               inputCmp.set("v.errors", null);
