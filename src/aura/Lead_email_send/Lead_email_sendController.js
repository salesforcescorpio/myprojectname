({
	doinit : function(component, event, helper) {
        ...
        console.log(component.get("v.AllLeads"));
        ...
        action.setCallback(this,function(data){
         ...
         var actionAcc = component.get("c.get_LeadsforPopup");
        console.log('component.get("v.Sel_leads") ',component.get("v.Sel_leads"));
        actionAcc.setParams({
            LeadIds:component.get("v.Sel_leads")
        });
        actionAcc.setCallback(this,function(data){
              console.log('>>>>>>>> <<<<<< ',data.getReturnValue());
         	component.set("v.AllLeads", data.getReturnValue());
    ...
    send_email : function(component, event, helper){
       alert('doc '+encodeURIComponent(component.get('v.fileString')).size);
        alert('mail sent');
        ...
        action.setParams({
            ...
            sel_account:component.get("v.Sel_leads"),
